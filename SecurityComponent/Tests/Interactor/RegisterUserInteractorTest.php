...
use SecurityComponent\Interactor\Presenter\RegisterUserPresenter;
use SecurityComponent\Interactor\Presenter\UserPresenter;
use SecurityComponent\Interactor\RegisterUserInteractor;
...
class RegisterUserInteractorTest extends BaseUserInteractorTest
{
    ...
    public function setUp()
    {
        ...
        $this->interactor = new RegisterUserInteractor($this->userGateway, $this->companyGateway);
    }
